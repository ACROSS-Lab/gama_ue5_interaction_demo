...
public:
	...
	bool IsConnected();
	void exit();
	void load(int64 socket_id, FString file_path, FString experiment_name, bool console = true, bool status = false, bool dialog = false, TArray<ExpParameter*> parameters = [], FString end_condition = "")
